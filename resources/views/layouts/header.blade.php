                ...
                <div class="col-12 ">
                    <div class="top_single_area d-flex align-items-center">
                        ...
                        <div class="header-cart-menu d-flex align-items-center ml-auto">
                            <!-- Cart Area -->
                            <div class="cart">
                                <a href="#" id="header-cart-btn" target="_blank"><span class="cart_quantity">{{count($dataHeaders)}}</span> <i class="ti-bag"></i> Rỏ hàng</a>
                                ...
                                <ul class="cart-list">
                                    ...
                                    <li class="total">
                                        ...
                                        <a href="{{route('product.listOrder')}}" class="btn btn-sm btn-cart">Cart</a>
